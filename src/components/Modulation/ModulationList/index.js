...
class ModulationList extends React.Component {
	constructor(props) {
		super(props);
		...
		return (
			<div>
				...
				<Fab
					...
					event="click"
					icon={<MdAdd />}
					onClick={() => handleNavigation('/modulation/add')}
					text="Adicionar Modulação"
				/>
			</div>
		);
	}
...
ModulationList.defaultProps = {};

export default ModulationList;
