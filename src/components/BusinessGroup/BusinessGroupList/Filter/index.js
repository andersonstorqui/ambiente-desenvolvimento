...
FilterBusinessGroup.propTypes = {
	businessLabel: PropTypes.string,
	businessInputProps: PropTypes.shape({}),
...
FilterBusinessGroup.defaultProps = {
	businessLabel: 'Grupo empresarial',
	businessInputProps: {
		name: 'group',
		id: 'group',
