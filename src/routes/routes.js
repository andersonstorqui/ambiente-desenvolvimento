...
const AmountsPage = React.lazy(() => import('screens/amounts/AmountsPage'));
const AmountsRegisterPage = React.lazy(() => import('screens/amounts/AmountsRegisterPage'));
...
const routes = [
	...
	},
	{
		path: '/amounts/add',
		name: 'montantes add',
		component: User(AmountsRegisterPage),
		permission: true,
		id: 151,
	},
	{
		path: '/amounts/editar/:id',
		name: 'montantes edit',
		component: User(AmountsRegisterPage),
		permission: true,
		id: 151,
